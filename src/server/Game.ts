    ...
    for (const player of game.getPlayersInGenerationOrder()) {
      ...
      if (!player.beginner ||
        ...
        gameOptions.ceoExtension) {
          ...
          const specificCardsOwen = ['Teractor','Celestic','Stormcraft Incorporated','Interplanetary Cinematics','Mining Guild','Recyclon','Terralabs Research','Septem Tribus','Valley Trust','Cheung Shing MARS','Thorgate'];
          const specificCardsLaura = ['Saturn Systems','Inventrix','PhoboLog','Viron','Morning Star Inc.','Factorum','Tharsis Republic','Aridor','Aphrodite','Point Luna','Splice'];
          const specificCardsJoel = ['Mons Insurance','Astrodrill','Lakefront Resorts','Pristar','CrediCor','Poseidon','Manutech','Pharmacy Union','Philares','Arcadian Communities','EcoLine'];
