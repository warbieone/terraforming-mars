<template>
    <div class="cards-filter">
        <h2 v-i18n>Extra cards to include from other expansions</h2>
        ...
        <div class="cards-filter-input">
            <div>
                <input class="form-input" :placeholder="$t('Start typing the card name to include')" v-model="searchTerm" />
            </div>
