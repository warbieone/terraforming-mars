        ...
        super({
            ...
            metadata: {
                ...
                renderData: CardRenderer_1.CardRenderer.builder((b) => {
                    ...
                    b.resource(CardResource_1.CardResource.ANIMAL).resource(CardResource_1.CardResource.ANIMAL).resource(CardResource_1.CardResource.MICROBE).resource(CardResource_1.CardResource.MICROBE).br;
                    b.resource(CardResource_1.CardResource.FLOATER).resource(CardResource_1.CardResource.FLOATER).wild(1).wild(1);
                    b.br;
                }),
