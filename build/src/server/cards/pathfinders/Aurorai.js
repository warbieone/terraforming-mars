        ...
        super({
            ...
            metadata: {
                ...
                renderData: CardRenderer_1.CardRenderer.builder((b) => {
                    b.megacredits(33).resource(CardResource_1.CardResource.DATA, 2).br;
                    b.effect('Whenever you increase your terraform rating, add 1 data per step to ANY card.', (eb) => {
                        eb.tr(1).startEffect.resource(CardResource_1.CardResource.DATA).asterix();
                    }).br;
                    b.effect('You can use data on this card as 3M€ each to pay for standard projects.', (eb) => {
                        eb.resource(CardResource_1.CardResource.DATA).startEffect.megacredits(3).asterix().text('standard project');
                    });
                }),
            },
        });
