        ...
        super({
            ...
            metadata: {
                ...
                renderData: CardRenderer_1.CardRenderer.builder((b) => {
                    b.effect('After you play a card with a microbe tag, increase your M€ production 1 step.', (eb) => eb.tag(Tag_1.Tag.MICROBE).startEffect.production((pb) => pb.megacredits(1)));
                }),
            },
        });
    }
