...
exports.synergies = new SynergyMap();
Milestones_1.Milestones.ALL.forEach((ma) => {
    exports.synergies.set(ma.name, ma.name, 1000);
});
Awards_1.Awards.ALL.forEach((ma) => {
    exports.synergies.set(ma.name, ma.name, 1000);
});
