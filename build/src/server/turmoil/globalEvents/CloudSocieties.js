...
const RENDER_DATA = CardRenderer_1.CardRenderer.builder((b) => {
    b.cards(1, { secondaryTag: AltSecondaryTag_1.AltSecondaryTag.FLOATER }).colon().resource(CardResource_1.CardResource.FLOATER).nbsp;
    b.resource(CardResource_1.CardResource.FLOATER).slash().influence();
});
